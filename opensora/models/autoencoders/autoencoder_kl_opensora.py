...
from .modeling_utils import DiagonalGaussianDistribution
from .modeling_utils import DecoderOutput, TilingMixin
...
class AutoencoderKLOpenSora(ModelMixin, ConfigMixin, TilingMixin):
    ...
    def enable_slicing(self):
        """Already enabled slicing."""
        pass
    def enable_tiling(self):
        """Already enabled tiling."""
        pass
